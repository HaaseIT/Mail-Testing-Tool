...
$C = array(
    'mail_to' => array(
         ...
         */
        'Main accounts',
        'mail@marcus.haase.name',
        'mail@haase-it.com',
        'marcus.haase@de.pwc.com',
        'Webmailer',
        'marcus.haase@gmail.com',
        'kerghug@hotmail.com',
        'agnus.thermopyle@yahoo.com',
        'agnus.thermopyle@web.de',
        'agnus.thermopyle@gmx.de',
        'agnus.thermopyle@aol.de',
        'agnus.thermopyle@t-online.de',
        'agnus.thermopyle@icloud.com',
        'Sonstige',
        'juergen.krupka@de.pwc.com',
        't.meyer@de.pwc.com',
        'simone.picard@de.pwc.com',
        'karina.loebbert@de.pwc.com',
        'florian.tschoepe@de.pwc.com',
        'matthias.frank@de.pwc.com',
        'bettina.holland@de.pwc.com',
        //'tobias.kirchhofer@shift.agency',
        //'frank.boes@shift.agency',
        'Mass Mailer',
        array(
            'mail@haase-it.com',
            'marcus.haase@gmail.com',
